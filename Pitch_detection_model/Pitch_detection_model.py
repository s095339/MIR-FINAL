...
# %%
#!apt-get install -q -y timidity libsndfile1
...
INPUT_SOURCE = "C:/Users/user/Downloads/test/recorded_audio.wav" #@param ["https://storage.googleapis.com/download.tensorflow.org/data/c-scale-metronome.wav", "RECORD", "UPLOAD", "./drive/My Drive/YOUR_MUSIC_FILE.wav"] {allow-input: true}
...
# %%
uploaded_file_name = "C:/Users/user/Desktop/MIR-FINAL/vocals.mp3"
